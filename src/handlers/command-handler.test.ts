...
describe('CommandHandler', () => {
  describe('parseCommand', () => {
    ...
    test('should parse /command-set', () => {
      const result = parseCommand('/command-set prime .agents/prime.md');
      expect(result.command).toBe('command-set');
      expect(result.args).toEqual(['prime', '.agents/prime.md']);
    });

    test('should parse /load-commands', () => {
      const result = parseCommand('/load-commands .agents/commands');
      expect(result.command).toBe('load-commands');
      expect(result.args).toEqual(['.agents/commands']);
    });
