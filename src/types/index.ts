/**
 * Core type definitions for Creative AI-Driven Coding Development platform
 */
...
export interface Session {
  ...
  chat_name: string; // Named chat support (default: 'default')
  started_at: Date;
  ended_at: Date | null;
}
 ...
 * Supports Droid (Factory) assistant
 */
